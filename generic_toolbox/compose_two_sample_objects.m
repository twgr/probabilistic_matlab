function [X, other_output] = compose_two_sample_objects(X,X_1,X_2,i_assign,n_1,n_2,other_out_1,other_out_2)
...
%
% Inputs:
%   X = Starting object to which things are added.  Typically this will be
%       a blank stack_object
...
if isempty(other_out_1) && isempty(other_out_2)
    other_output = [];
else
